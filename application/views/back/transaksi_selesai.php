            ...
            <div class="card-box">
               <div class="row">
                    <div class="col-md-11">
                      ...
                      <?php echo form_open("admin/transaksi/transaksi_selesai_act", $form_open);?>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <select name="kostumer" class="form-control" id="exampleSelect1" disabled>
                        ...
                        <div class="form-group">
                           ...
                           <select name="mobil" class="form-control" id="exampleSelect1" disabled>
                             <option value="">-Pilih Mobil-</option>
                       			<?php foreach($mobil as $m){ ?>
                       			<option <?php if($t->transaksi_mobil == $m->mobil_id){echo "selected='selected'";} ?> value="<?php echo $m->mobil_id; ?>"><?php echo $m->mobil_merek; ?></option>
                       			<?php } ?>
                       		</select>
                        ...
                        <div class="form-group">
                           ...
                           <div>
                              <div class="input-daterange input-group" id="date-range">
                                 <input disabled type="text" class="form-control" name="tgl_pinjam" value="<?php echo $t->transaksi_tgl_pinjam ?>">
                                 <span class="input-group-addon bg-custom b-0">to</span>
                                 <input disabled type="text" class="form-control" name="tgl_kembali" value="<?php echo $t->transaksi_tgl_kembali ?>">
                              </div>
                           </div>
                        </div>
                        ...
                        <fieldset class="form-group">
                          ...
                          <?php echo form_input($harga, $t->transaksi_harga);?>
                          <?php echo form_error('harga'); ?>
                        </fieldset>
                        <fieldset class="form-group">
                          <label for="exampleSelect1">Charge limit/day</label>
                          <?php echo form_input($denda, $t->transaksi_denda);?>
                          <?php echo form_error('denda'); ?>
                        </fieldset>
                        <div class="form-group">
                          <label>Date of car returned</label>
                          <div>
                            <div class="input-group">
                              <input type="text" class="form-control" name="tgl_dikembalikan" placeholder="mm/dd/yyyy" id="datepicker-autoclose">
